Пример бизнес-правила, определённого в `resources/TaxiFareRule.drl`
Суть правила в расчёте стоимости поездки, в зависимости от расстояния и ночной наценки:
...
Для передачи данный по тарифу используется `POST localhost:5001/api/calcTaxiFare`

      Body: 
      {
      "isNightSurcharge": true, /* признак использования ночной наценки */
      "distanceInMile": 9       /* дистанция */
      }
Пример Response:

      {
      "nightSurcharge": 40,  /* стоимость наценки */
      "rideFare": 90,        /* стоимость по обычному тарифу */ 
      "totalFare": 130       /* итоговая стоимость */
      }
